  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="container max-w-md mx-auto px-4 py-6 space-y-6">
        <div className="gradient-success rounded-3xl p-6 text-white mb-6">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full bg-card border border-border rounded-2xl py-4 pl-12 pr-4 outline-none focus:ring-2 focus:ring-primary shadow-sm"
          />
        </div>
          ...
          <>
            ...
            {totalActivities > itemsPerPage && (
              <div className="flex items-center justify-center gap-2 py-6">
                ...
                <div className="flex items-center gap-1 overflow-x-auto max-w-[200px] sm:max-w-none scrollbar-hide px-2">
                  {Array.from({ length: Math.ceil(totalActivities / itemsPerPage) }, (_, i) => i + 1)
                    .filter(page => {
                    ...
                    .map((page, idx, arr) => (
                      <div key={page} className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className={`w-10 h-10 flex-shrink-0 rounded-lg font-medium text-sm transition-colors ${currentPage === page
                ...
                <button
                  onClick={() => setCurrentPage(prev => Math.min(Math.ceil(totalActivities / itemsPerPage), prev + 1))}
