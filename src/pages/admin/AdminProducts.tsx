                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-2 mt-2">
                            ...
                            <div className="flex items-center gap-2">
                                <code className="text-xs font-mono text-slate-600 bg-white border border-slate-200 rounded px-2 py-2 flex-1 truncate select-all">
                                    {`https://gypzrzsmxgjtkidznstd.supabase.co/functions/v1/product-webhook?key=${(product as any).webhook_key}`}
                                </code>
                                <Button
                                    type="button"
                                    variant="outline"
                                    ...
                                    onClick={() => {
                                        navigator.clipboard.writeText(`https://gypzrzsmxgjtkidznstd.supabase.co/functions/v1/product-webhook?key=${(product as any).webhook_key}`);
                                    ...
                                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-2 space-y-1">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <code className="text-[10px] text-slate-600 bg-white border border-slate-200 rounded px-1.5 py-0.5 flex-1 truncate">
                                                {`https://gypzrzsmxgjtkidznstd.supabase.co/functions/v1/product-webhook?key=${product.webhook_key}`}
                                            </code>
                                            <button
                                                onClick={() => {
                                                    navigator.clipboard.writeText(`https://gypzrzsmxgjtkidznstd.supabase.co/functions/v1/product-webhook?key=${product.webhook_key}`);
                                                }}
