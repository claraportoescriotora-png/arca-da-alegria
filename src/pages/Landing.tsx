    ...
    return (
        <div className="min-h-screen bg-[#FFF8F0] font-fredoka">
            ...
            <section className="py-20 bg-white overflow-hidden">
                <div className="container max-w-6xl mx-auto px-6 text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
                        O que as famílias estão vivendo...
                    </h2>
                    <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
                        Milhares de pais já decidiram proteger o coração de seus filhos. Veja o que eles dizem sobre o ambiente do Meu Amiguito:
                    </p>
                </div>
                
                <div className="relative group/carousel max-w-6xl mx-auto px-6">
                    {/* Navigation Buttons */}
                    <button
                        onClick={() => scroll(testimonialsScrollRef, 'left')}
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white shadow-xl text-purple-600 hover:bg-purple-600 hover:text-white transition-all opacity-0 group-hover/carousel:opacity-100 hidden md:flex active:scale-95"
                        aria-label="Anterior"
                    >
                        <ChevronLeft className="w-8 h-8" />
                    </button>
                    <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white shadow-xl text-purple-600 hover:bg-purple-600 hover:text-white transition-all opacity-0 group-hover/carousel:opacity-100 hidden md:flex active:scale-95"
                        aria-label="Próximo"
                    >
                        <ChevronRight className="w-8 h-8" />
                    </button>
                    ...
                    >
                        {testimonials.map((t, i) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity"></div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-purple-600 font-bold text-lg animate-pulse">
                        ⭐ Conteúdo que transforma gerações ⭐
                    </p>
                </div>
            </section>
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 right-6 z-[60] bg-green-600 hover:bg-green-700 text-white p-4 rounded-full shadow-2xl transition-all hover:scale-110 active:scale-95 group animate-bounce-slow"
                title="Fale conosco no WhatsApp"
            >
                <div className="absolute -top-12 right-0 bg-white text-gray-800 text-xs font-bold px-3 py-2 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border-2 border-green-100 pointer-events-none mb-2">
